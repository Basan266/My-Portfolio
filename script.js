...
function sendEmail(){
    ...
    Email.send({
        ...
        Username : "robertbasan26@gmail.com",
        Password : "EEBDE9624B49A7706F38EF3994999AFAB668",
        To : 'robertbasan26@gmail.com',
        From : "robertbasan26@gmail.com",
      ...
      message => {
        if (message == "OK"){
            Swal.fire({
                title: "Success!",
                text: "Message sent Successfuilly!",
                icon: "success"
              });
        }
      }
